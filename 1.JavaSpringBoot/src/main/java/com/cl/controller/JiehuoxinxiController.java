...
public class JiehuoxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiehuoxinxiEntity jiehuoxinxi,
		...
		if(tableName.equals("tuanzhang")) {
			jiehuoxinxi.setTuanzhangzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			jiehuoxinxi.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R info(@PathVariable("id") Long id){
		...
		jiehuoxinxi = jiehuoxinxiService.selectView(new EntityWrapper<JiehuoxinxiEntity>().eq("id", id));
