...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.shangpinxiangqing = res.data.data.shangpinxiangqing.replace(reg,'../../../cl99870143/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		context?.$http({
			...
			if(json.hasOwnProperty('tuanzhangzhanghao') && context?.$toolUtil.storageGet("frontRole")!="管理员"){
				form.value.tuanzhangzhanghao = json.tuanzhangzhanghao
				disabledForm.value.tuanzhangzhanghao = true;
			}
			if(json.hasOwnProperty('tuanzhangxingming') && context?.$toolUtil.storageGet("frontRole")!="管理员"){
				form.value.tuanzhangxingming = json.tuanzhangxingming
				disabledForm.value.tuanzhangxingming = true;
			}
			if(json.hasOwnProperty('zitidianmingcheng') && context?.$toolUtil.storageGet("frontRole")!="管理员"){
