		...
		<div class="usersView">
			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="12">
							<el-form-item prop="tuanzhangzhanghao" label="团长账号">
								<el-input class="list_inp" v-model="userForm.tuanzhangzhanghao" placeholder="团长账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
						...
						<el-col :span="12">
							<el-form-item prop="tuanzhangxingming" label="团长姓名">
								<el-input class="list_inp" v-model="userForm.tuanzhangxingming" placeholder="团长姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
						...
						<el-col :span="12">
							<el-form-item prop="zitidianmingcheng" label="自提点名称">
								<el-input class="list_inp" v-model="userForm.zitidianmingcheng" placeholder="自提点名称" ></el-input>
							</el-form-item>
						</el-col>
					</el-row>
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			context?.$toolUtil.storageSet("frontName", res.data.data.tuanzhangzhanghao)
