	...
	<div class="app-contain" :style='{"padding":"20px 20px","margin":"20px auto 40px","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">团长账号</div>
					<div  class="info_text" >{{detail.tuanzhangzhanghao}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">团长姓名</div>
					<div  class="info_text" >{{detail.tuanzhangxingming}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">自提点名称</div>
					<div  class="info_text" >{{detail.zitidianmingcheng}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">接货时间</div>
					<div  class="info_text" >{{detail.jiehuoshijian}}</div>
				</div>
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'取货')" @click="quhuoxinxionAcross('取货','quhuoxinxi','','','')" type="warning">取货</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('jiehuoxinxi','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jiehuoxinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jiehuoxinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const quhuoxinxionAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
