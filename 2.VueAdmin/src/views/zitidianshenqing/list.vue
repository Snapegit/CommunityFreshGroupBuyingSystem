	...
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form" >
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.zitidianmingcheng" placeholder="自提点名称"
								clearable>
							</el-input>
						</div>
					</div>
				...
				<br>
				<div class="btn_view">
					<el-button type="success" @click="addClick" v-if="btnAuth('zitidianshenqing','新增')">新增</el-button>
					<el-button  v-if=" btnAuth('zitidianshenqing','查看')" type="info"  :disabled="selRows.length==1?false:true" @click="infoClick(null)">详情</el-button>
					<el-button type="primary" :disabled="selRows.length==1?false:true" @click="editClick" v-if=" btnAuth('zitidianshenqing','修改')">修改</el-button>
					<el-button type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('zitidianshenqing','删除')">删除</el-button>
				</div>
			</div>
			<br>
			<el-table
				...
				ref="table"
				v-if="btnAuth('zitidianshenqing','查看')"
				:data="list"
				...
				<el-table-column label="审核" v-if="btnAuth('zitidianshenqing','审核')" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button type="info" v-if=" btnAuth('zitidianshenqing','查看')" @click="infoClick(scope.row.id)">详情</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
...
<script setup>
	...
	//基础信息
	const tableName = 'zitidianshenqing'
	const formName = '自提点申请'
	...
	const getList = () => {
		...
		params['sort'] = 'id'
		params['order'] = 'desc'
		if(searchQuery.value.zitidianmingcheng&&searchQuery.value.zitidianmingcheng!=''){
			params['zitidianmingcheng'] = '%' + searchQuery.value.zitidianmingcheng + '%'
		}
	...
	const approvalClick = (row) => {
		let params = {
			id:row.id,
			zitidianmingcheng: row.zitidianmingcheng,
			dizhi: row.dizhi,
			tuanzhangzhanghao: row.tuanzhangzhanghao,
			tuanzhangxingming: row.tuanzhangxingming,
			sfsh: row.sfsh,
			shhf: row.shhf,
		}
		nextTick(() => {
