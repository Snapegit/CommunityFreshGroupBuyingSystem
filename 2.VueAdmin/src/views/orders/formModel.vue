		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="商户名称" prop="tuanzhangzhanghao">
							<el-input class="list_inp" v-model="form.tuanzhangzhanghao" placeholder="商户名称"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.logistics = res.data.data.logistics?(res.data.data.logistics.replace(reg,'../../../cl99870143/file')):'';
