	...
	<div>
		...
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">团长账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.tuanzhangzhanghao" 
						 placeholder="请输入团长账号"
						 type="text"
						/>
				</div>
				...
				<div class="list_item">
					<div class="list_label">团长姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.tuanzhangxingming" 
						 placeholder="请输入团长姓名"
						 type="text"
						/>
				</div>
				...
				<div class="list_item">
					<div class="list_label">自提点名称：</div>
					<el-input class="list_inp"
						 v-model="registerForm.zitidianmingcheng" 
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.tuanzhangzhanghao)){
		...
		if((!registerForm.value.tuanzhangxingming)){
