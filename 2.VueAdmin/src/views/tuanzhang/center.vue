				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="团长账号" prop="tuanzhangzhanghao">
							<el-input class="list_inp" v-model="user.tuanzhangzhanghao" readonly placeholder="团长账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="团长姓名" prop="tuanzhangxingming">
							<el-input class="list_inp" v-model="user.tuanzhangxingming"  placeholder="团长姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="tuanzhangtouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="性别" prop="xingbie">
							<el-select 
								...
								placeholder="请选择性别"
								>
								<el-option v-for="item in tuanzhangxingbieLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="24">
					...
					<el-col :span="24">
						<el-form-item label="自提点名称" prop="zitidianmingcheng">
							<el-input class="list_inp" v-model="user.zitidianmingcheng"  placeholder="自提点名称" clearable />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const tableName = ref('tuanzhang')
	const user = ref({})
	const tuanzhangxingbieLists = ref([])
	const init = () => {
		tuanzhangxingbieLists.value = "男,女".split(',')
	}
	const tuanzhangtouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.tuanzhangzhanghao)){
			context?.$toolUtil.message(`团长账号不能为空`,'error')
			return false
		}
		if((!user.value.mima)){
		...
		if((!user.value.tuanzhangxingming)){
			context?.$toolUtil.message(`团长姓名不能为空`,'error')
			return false
		}
